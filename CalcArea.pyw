...
container_geral = tk.Frame(janela, bg=cor["Fundo"], padx=10, pady=10)
container_geral.pack()

container_display = tk.Frame(container_geral, bg=cor["Fundo"], padx=10, pady=10)
...
container_telcadonumerico = tk.Frame(container_geral, bg=cor["Fundo"], padx=10, pady=20)
...
container_opcoes = tk.Frame(container_geral, bg=cor["Fundo"], padx=10, pady=20)
